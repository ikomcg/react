    ...
    return (
        <footer className='p-8'>
            ...
            <div className='flex justify-between pt-3'>
                ...
                <ul className='flex'>
                    <li className='mx-1'>
                        <a href="https://www.facebook.com/miko.gurrobat/"  target='_blank'>
                            <BsFacebook className='text-fb text-2xl hover:scale-105' />
                        </a>
                    </li >
                    <li className='mx-1'>
                        <a href="https://www.linkedin.com/in/miko-gurrobat-4b621a256/"  target='_blank'>
                            <AiFillLinkedin className='text-fb text-2xl hover:scale-105'/>
                        </a>
                    </li>
                    <li className='mx-1'>
                        <a href="https://myjobstreet.jobstreet.com.ph/resume/preview-resume.php?x=3uv9mcjt1a8l0qdhc61ffpf4v7"  target='_blank'>
