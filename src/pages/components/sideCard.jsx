    ...
    useEffect(()=>{
        switch(url){
            case '/about':
                ...
                <a href='https://drive.google.com/file/d/10Y01DIfvM5Bm-NGq-v2Csu9ul2EyMJJI/view?usp=share_link' className='bg-bgviol text-white font-medium text-lg py-1 px-5 rounded-lg hover:scale-105 hover:cursor-pointer' target='_blank'>my resume</a>
            </div>);
                setImage(about)
                break;
            case '/project':
