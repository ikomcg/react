    ...
    return (
        ...
        <div key={index} className='project-card flex flex-row mb-5 flex-nowrap items-start '>
            <div className="home-projects flex flex-col image-left p-2 overflow-hidden w-7/12" >
                ...
                {
                    btn_Link? 
                    <a href={items.link} target='_blank' className='bg-kodego font-bold rounded-xl  px-5 py-1.5 text-bgviol w-max hover:scale-105'>{items.title}</a>
                    : <a href='https://kodego.ph/' target='_blank' className='text-bgviol w-max hover:scale-105'>Kodego.ph</a>
                }
            </div>
                    ...
                    <div className='flex items-center justify-center my-2'>
                        <ul>
                            <li className='flex items-center justify-center underline'>
                                <a href={items.link} target='_blank' className='text-bgviol '>
                                VIEW 
                                </a>
